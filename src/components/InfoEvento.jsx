  ...
  <h2 className="text-2xl md:text-3xl font-lora font-bold text-primary mt-2">Información del Evento</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl mb-8 items-stretch justify-center">
        ...
        <div className="flex flex-col items-center bg-white rounded-2xl shadow-xl border-2 border-primary p-6 text-center h-full">
          ...
          <span className="text-primary font-semibold">Sábado 20 de diciembre 2025</span>
          <span className="text-primary">17:00 hs</span>
          <span className="text-primary">Iglesia San Juan</span>
          <span className="text-primary text-sm">Calle Falsa 456, Ciudad</span>
        </div>
        {/* Card Dress Code */}
        <div className="flex flex-col items-center bg-white rounded-2xl shadow-xl border-2 border-primary p-6 text-center h-full">
          <img src="/img/servicios/parejas.svg" alt="Dress code elegante" className="w-16 h-16 mb-4 object-contain" style={{filter: 'drop-shadow(0 0 2px #5A0B0B)'}} />
          <span className="font-lora text-primary font-bold text-xl mb-2">¿Cómo ir vestido?</span>
          <span className="text-primary font-semibold">Elegante</span>
          <span className="text-primary">Sugerimos traje y vestido largo</span>
        </div>
        {/* Card Fiesta */}
        <div className="flex flex-col items-center bg-white rounded-2xl shadow-xl border-2 border-primary p-6 text-center h-full">
          <svg width="48" height="48" fill="none" viewBox="0 0 48 48" className="mb-4" xmlns="http://www.w3.org/2000/svg">
            <circle cx="24" cy="24" r="20" stroke="#5A0B0B" strokeWidth="2" fill="#fff"/>
            <path d="M24 14a8 8 0 0 1 8 8c0 5-8 12-8 12s-8-7-8-12a8 8 0 0 1 8-8zm0 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" fill="#5A0B0B"/>
          </svg>
          <span className="font-lora text-primary font-bold text-xl mb-2">Fiesta</span>
          <span className="text-primary font-semibold">Salón Los Robles</span>
          <span className="text-primary">21:00 hs</span>
          <span className="text-primary text-sm">Av. Siempreviva 123, Ciudad</span>
          <a
