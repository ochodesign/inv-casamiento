...
const Galeria = () => {
  ...
  return (
  <section className="w-full py-10 px-2 sm:px-4 bg-[#fff5f5] flex flex-col items-center overflow-x-hidden mt-20">
  <h2 className="text-2xl md:text-3xl font-lora font-bold text-primary mb-6">Sobre Nosotros</h2>
      <div className="flex flex-col items-center mb-6">
        ...
        <p className="text-primary font-lora text-center max-w-xl">Nuestra historia juntos está llena de momentos únicos. ¡Queremos compartir este día especial con vos!</p>
      </div>
